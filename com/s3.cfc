...
--->
	...
	<cffunction name="putObject" access="public" output="true" returntype="string" description="Puts an object into a bucket.">
		<cfargument name="bucketName" type="string" required="yes">
		<cfargument name="fileKey" type="string" required="yes">
		<cfargument name="contentType" type="string" required="yes">
		<cfargument name="HTTPtimeout" type="string" required="no" default="300">
		...
		<cfargument name="uploadDir" type="string" required="yes">
	...
	<cffunction name="deleteObject" access="public" output="false" returntype="boolean" 
		...
		<cfargument name="fileKey" type="string" required="yes">
		<cftry>			
			<cfset base = "s3://#variables.accessKeyId#:#variables.secretAccessKey#@/#arguments.bucketName#"/>
			<cfset FileDelete(base&'/#arguments.fileKey#') />
			<cfcatch>
				<cfreturn false>				
			</cfcatch>
		</cftry>
